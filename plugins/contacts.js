export default defineNuxtPlugin(() => {
    const contacts = {
        ...
        legal_address: {
            ru: 'Республика Казахстан, Западно-Казахстанская область, г. Уральск, ул. М. Ихсанова 38, н.п.2, каб 210',
            kk: 'Қазақстан Республикасы, Батыс Қазақстан облысы, Орал қ, М. Ықсанов көш 38, н.п.2, каб 210',
