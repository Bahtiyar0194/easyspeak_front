        ...
        <div class="col-span-12 md:col-span-6">
          ...
          <div class="pt-4">
            ...
            <p class="mb-0">
              {{ $t("registered_at") }}:
              <b>{{
                new Date(schoolStore.schoolData.created_at).toLocaleDateString()
              }}</b>
            </p>
          </div>
        </div>
        ...
        <div class="col-span-12 md:col-span-6">
          ...
          <div class="pt-4">
            <p class="mb-3">
              ...
              <b class="text-corp">{{ schoolStore.schoolData.school_name }}</b>
            </p>
            <p class="mb-3">
                      ...
                      <div class="col-span-12">
                        <div class="form-group-border active">
                          ...
                          <input
                            ...
                            placeholder=" "
                          />
                          <label :class="{ 'label-error': errors.cardNumber }">
                            {{
                              errors.cardNumber
                                ? $t(
