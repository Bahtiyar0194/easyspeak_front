export default {
    ...
    choose_answer_option: "Әр сөйлемге немесе сұраққа жауап нұсқасын таңдаңыз",
    download: "Жүктеп алу",
    loading: "Өтінеміз, күте тұрыңыз, жүктелуде",
    ...
    recording_too_short: "Жазба тым қысқа",
    recording_too_long: "Жазба тым ұзақ",
    recording_silent: "Жазба тым тыныш",
    ...
    materials: {
        ...
        chat: {
            ...
            material: {
                description: `👨‍🏫 Мен сіздің виртуалды мұғаліміңіз және оқытудағы көмекшіңіз боламын. Менің міндетім - сіз оқып жатқан материалды түсінікті және сабырлы түрде түсіндіру, қиын тақырыптарды түсінуге көмектесу және сұрақтарға біртіндеп жауап беру.
                Егер бірдеңе қиын болып көрінсе-айтыңыз, Мен басқаша түсіндіремін. Бірге үйренейік!😊`,
                prompts: {
            ...
            speaking: {
                description: `Мен сіздің ағылшын тілі бойынша ЖИ-мұғаліміңізбін. Егер сіз бұрын ағылшын тілін мүлдем оқымаған болсаңыз да, бұл мәселе емес — біз ең қарапайым негіздерден бастап, біртіндеп алға жылжимыз.
                
                ✨ Мұнда күрделі сұрақтар мен қате жауаптар жоқ. Өз қарқыныңызбен үйреніңіз, кез келген сұрақ қойыңыз және қателесуден қорықпаңыз — қателіктер үйренуге көмектеседі.
                Мен сізге көмектесемін:
                • жаңа сөздерді есте сақтауға;
                • ағылшын тіліндегі сөйлеуді түсінуге;
                • айтылымды жақсартуға;
                • грамматиканы меңгеруге;
                • ағылшын тілінде сөйлесу дағдыларын дамытуға.
                
                Сіз менімен қазақ немесе қазақ тілінде сөйлесе аласыз, ал дайын болған кезде біртіндеп ағылшын тіліне көше аласыз.
                
                🚀 Ағылшын тілі әлеміне саяхатыңызды бастауға дайынсыз ба?`,
                prompts: {
                    text_1: '👋 Танысайық',
                    text_2: '🚀 Басынан бастап үйренейік',
                    text_3: '🎯 Менің деңгейімді анықта',
                    text_4: '💬 Ағылшынша сөйлесейік'
                }
            }
        }
    },
    ...
    pages: {
        ...
        home: {
            ...
            hero: {
                ...
                description: 'Бізбен бірге оқып немесе оқушыларды біздің әдістеме бойынша оқытыңыз. Онлайн мектептер үшін дайын шешім.',
                btn_1: 'Өз бетінше ЖИ мұғалім арқылы үйрену',
                btn_2: 'EasySpeak мұғалімі арқылы үйрену',
                btn_3: 'Мектеп тіркеу'
            },

            video: {
                title: 'Платформа туралы видео'
            },
        ...
        subscription: {
            plan: 'Жазылу жоспары',
            your_plan: 'Сіздің жоспар',
            expired: 'Платформада жұмысты жалғастыру үшін сізге жазылымның мерзімін ұзарту қажет',
            expired_at: 'Жазылымның біту уақыты',
            prolongation_title: 'Жазылым уақытын ұзарту',
            prolongation: 'Ұзарту',
            choose_a_plan: 'Жазылым жоспарын таңдаңыз',
            months: "{n} айға жазылу",
            no_subscriptions: "Бұл курсқа жазылымдар әзірше қарастырылмаған"
        },
        ...
        schedule: {
            ...
            options: 'Сабақ кестесінің баптаулары',
            only_future: {
                title: 'Жаңа сабақ кестесін тек болашақ сабақтарға қолдану',
                description: 'Өткен сабақтар тарихта өзгеріссіз қалады. Жаңа кесте бірінші аяқталмаған сабақтан бастап күшіне енеді.'
            },
            new_schedule: {
                title: 'Сабақ кестесін жаңадан құру',
                description: 'Жаңа кесте басынан бастап курсқа толығымен қолданылады. Барлық сабақтардың, соның ішінде өткен сабақтардың күндері қалпына келтіріліп, қайта құрылады.'
            }
        },
        ...
        conference: {
            ...
            plan: 'Конференция жоспарлау',
            plan_alt: 'Конференцияны жоспарлау',
            mic: 'Микрофон',
            ...
            start_time: 'Конференцияның басталу уақыты',
            ...
            not_appointed: 'Сіз әлі мектептегі ешбір топқа мұғалім ретінде тағайындалмаған секілдісіз. Бұл мәселені шешу үшін мектеп әкімшілігімен хабарласыңыз. Егер сіз әкімші болсаңыз, алдымен топ құруыңыз қажет.',
            assign_a_mentor_only_for_this_lesson: 'Тек осы сабаққа ғана мұғалім етіп тағайындау',
            appoint_a_mentor_for_this_and_subsequent_lessons: 'Осы және келесі сабақтарға мұғалім етіп тағайындау',
            appoint_a_mentor_for_this_and_subsequent_lessons_note: 'Таңдаған мұғаліміңіз топтың осы және келесі сабақтарына тағайындалады.',
            ...
            not_bought: 'Конференцияға қатысу үшін сіз осы курстардың біреуіне жазылу керексіз: {courses}.',
            free_conference: 'Тегін конференция (курсқа жазылғанын тексермеу)',
            mode: {
                grid: 'Кесте',
                slider: 'Карусель'
            },
            ...
            messages: {
                ...
                access_denied: 'Конференцияға тек тегін болған кезде немесе сіз топта болған кезде немесе осы конференцияға қатысу үшін алдын ала жазылған кезде ғана кіруге рұқсат етіледі.',
            },
            statuses: {
                current: 'Ағымдағы',
            ...
            topic: {
                title: 'Конференцияның тақырыбы',
                description: 'Конференция туралы сипаттама'
            },
            poster: {
                title: 'Конференцияның постерлік суреті',
                required: 'Конференцияның постерлік суретін таңдаңыз'
            },
            accept: {
                title: 'Қатысамын',
                success: {
                    title: 'Құттықтаймыз! Сіз конференцияға сәтті тіркелдіңіз.',
                    description: 'Сіз "{conf_name}" конференциясында өз орныңызды алдыңыз. Конференцияға кіру сілтемесі сіздің жеке кабинетіңізде конференция басталардан 10 минут бұрын пайда болады. Тіл білімі деңгейіңізді көтеруге дайын болыңыз! 🚀',
                    url_desc_1: 'Конференцияға өту үшін',
        ...
        courses: {
            ...
            course_level: 'Курстың деңгейі',
            choose_a_course_level: 'Курстың деңгейін таңдаңыз',
            ...
            purchase: 'Барлық сабақтарға толық қол жеткізу үшін осы курсқа жазылыңыз',
            has_expired: 'Жазылу мерзімі аяқталды, жалғастыру үшін сізге осы курсқа қайта жазылу қажет',
            purchase_button: 'Жазылу',
        ...
        lessons: {
            ...
            is_unavailable_desc: 'Сабақ мұғаліммен конференция немесе бақылау жұмысы өткеннен кейін қолжетімді болады.',
        ...
        questions: {
            ...
            answer: {
                ...
                select_one_alt: 'Жауап нұсқаларының біреуін таңдаңыз',
                select_few: 'Бірнеше жауап нұсқаларын таңдаңыз'
            },
            answers: 'Жауаптар',
        ...
        tasks: {
            ...
            start_an_other_task: 'Басқа тапсырманы бастау',
            select_a_task: 'Тапсырманы таңдау',
            select_a_task_alt: 'Тапсырманы таңдау',
            ...
            not_started: {
                mentor: 'Сіз оқушыларға арналған бірде бір тапсырманы әлі бастаған жоқсыз',
                learner: 'Мұғалім әзірше бірде бір тапсырманы бастаған жоқ'
            },
            not_completed: {
                learner: 'Әзірше бұл тапсырманы ешқандай оқушы орындаған жоқ'
            },
            task_materials: 'Тапсырманың материалдары',
            try_again: 'Қайта орындау',
            next_task: 'Келесі тапсырма',
            run: {
                title: 'Тапсырманы іске қосу',
                self: 'Маған іске қосу',
                learner: 'Оқушыға іске қосу'
            },
            launched: {
                title: 'Тапсырма іске қосылды',
                learner: 'Оқушыларға іске қосылды'
            },
            ...
            check: {
                ...
                by_mentor: 'Жауапты мұғалім арқылы тексеру',
            },
