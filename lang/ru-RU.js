export default {
    ...
    pages: {
        ...
        tasks: {
            ...
            missing_words: {
                options: {
                    option_1: 'Заполнить пропуск в фразе (с подсказками)',
                    option_2: 'Заполнить пропуск в фразе (без подказок)',
                    option_3: 'Заполнить пропуск в фразе (с первой буквой)',
                    option_4: 'Заполнить пропуск в фразе (с одним из вариантов)'
                },
                note_1: 'Кликните на слово, которое нужно скрыть из фразы.'
            },
            match_paired_words: {
                note_1: 'Добавьте секцию. В секции создайте пару слов, основываясь на словаре (например, синонимы, антонимы и т.д.). По умолчанию второе слово из пары будет скрыто. Вы можете выбрать, какое слово скрыть, кликнув на него. Допускается добавление неограниченного количества секций с парами слов.'
            },
            find_an_extra_word: {
