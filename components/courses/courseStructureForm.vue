    ...
    <div class="col-span-12">
      <div class="form-group-border select active label-active">
        ...
        >
          ...
          <option
            v-for="(course, courseIndex) in courseAttributes.courses"
            :key="courseIndex"
    ...
    <div v-if="selectedLevelId" class="col-span-12">
      <div class="form-group-border select active label-active">
        ...
        >
          ...
          <option
            v-for="(section, sectionIndex) in selectedLevel?.sections"
            :key="sectionIndex"
    ...
    <div v-if="selectedSectionId" class="col-span-12">
      <div class="form-group-border select active label-active">
        ...
        <label :class="{ 'label-error': errors.lesson_id }">
          {{
            errors.lesson_id ? errors.lesson_id[0] : $t("pages.lessons.lesson")
          }}
        </label>
      </div>
    </div>
