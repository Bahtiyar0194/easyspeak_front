<template>
  <th
    ...
    @click="sortTable()"
    :title="
      props.sortKey !== props.keyName
        ? $t('sort_by_this_column')
  ...
  >
    <div class="flex items-center gap-1">
      ...
      <i
        v-if="props.sortKey === props.keyName"
        class="pi text-[10px] text-corp"
        :class="
          props.sortDirection === 'asc'
            ? 'pi-sort-' + props.sortType + '-down'
            : 'pi-sort-' + props.sortType + '-down-alt'
        "
      ></i>
    </div>
  </th>
