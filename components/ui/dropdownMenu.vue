  ...
  <div class="dropdown" ref="dropdownWrapper">
    <button @click="showDropdown">
      <div class="flex items-center gap-0.5">
        ...
        <svg v-if="props.dropdownArrow === true" class="duration-200" :style="dropdownMenuOpen === true ? 'transform: rotate(180deg);' : ''" width="16"
          height="16" viewBox="0 0 15 15" fill="none" xmlns="http://www.w3.org/2000/svg">
          <path
    ...
    <ul class="dropdown-menu" ref="dropdownMenu" @click="hideDropdown"
      :class="{ show: dropdownMenuOpen === true, right: props.position === 'right' }">
