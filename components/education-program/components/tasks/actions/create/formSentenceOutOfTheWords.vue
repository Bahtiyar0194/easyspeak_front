...
const newTaskSteps = [
    ...
    },
    {
        ...
        props: { errors, showImage: false, showAudioButton: false, showTranscription: false, showTranslate: false, showImpressionLimit: false, showSecondsPerSentence: true, showSelectMainLang: true },
        modalSize: '2xl'
    }
];
