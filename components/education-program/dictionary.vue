                        ...
                        <div class="custom-grid">
                            ...
                            <div class="col-span-12">
                                <multipleSelect :className="'form-group-border select active label-active'"
                                    ...
                                    :avatar="true" :onChange="debounceWords" />
                            </div>
                            ...
                            <div class="col-span-12">
                                <multipleSelect :className="'form-group-border select active label-active'"
                                    ...
                                    :optionLabel="'status_type_name'" :onChange="debounceWords" />
                            </div>

                            <div class="col-span-12">
                                <div class="form-group-border active">
                                    <i class="pi pi-calendar"></i>
                                    <input type="date" name="created_at_from" @input="debounceWords" placeholder=" " />
                            ...
                            <div class="col-span-12">
                                <div class="form-group-border active">
                                    <i class="pi pi-calendar"></i>
                                    <input type="date" name="created_at_to" @input="debounceWords" placeholder=" " />
            ...
            <template v-if="words.data?.length > 0">
                <div class="table table-striped table-sm selectable">
                    ...
                    <table ref="tableRef">
                        ...
                        <tbody>
                            <tr v-for="word in words.data" :key="word.word_id" @click="getWord(word.word_id)">
                                <td>{{ word.word }}</td>
                                ...
                                <td>
                                    <div class="flex items-center gap-x-4">
                                        <audioButton v-if="word.audio_file"
                                            :src="config.public.apiBase + '/media/get/' + word.audio_file" @click.stop />
                                        <div v-if="word.image_file"
                                            :style="{ 'backgroundImage': 'url(' + config.public.apiBase + '/media/get/' + word.image_file + ')' }"
                ...
                <div class="btn-wrap mt-4">
                    <pagination :items="words" :setItems="getWords" :onSelect="(count) => perPage = count" />
                    <client-only>
                        <tableToExcelButton :table="tableRef"
                            :fileName="$t('pages.dictionary.title') + ' - ' + new Date().toLocaleString()"
                            :className="'btn-sm'" />
                    </client-only>
                </div>
            </template>
                ...
                <form @submit.prevent="addWordSubmit" ref="addFormRef">
                    <div class="custom-grid">
                        <div class="col-span-12">
                            <div class="form-group-border active">
                                <i class="pi pi-align-left"></i>
                                <input autoComplete="new-word" name="word" type="text" placeholder=" " />
                        ...
                        <div class="col-span-12">
                            <div class="form-group-border active">
                                <i class="bi bi-braces"></i>
                                <input autoComplete="new-word-transcription" name="transcription" type="text"
                                    placeholder=" " />
                        ...
                        <div class="col-span-12">
                            <div class="form-group-border active">
                                <i class="pi pi-align-left"></i>
                                <input autoComplete="new-word-kk-translate" name="word_kk" type="text"
                                    placeholder=" " />
                                <label :class="{ 'label-error': errors.word_kk }">
                                    {{ errors.word_kk ? errors.word_kk[0] : $t("pages.dictionary.translate.kk") }}
                                </label>
                            </div>
                        </div>
                        ...
                        <div class="col-span-12">
                            <div class="form-group-border active">
                                <i class="pi pi-align-left"></i>
                                <input autoComplete="new-word-ru-translate" name="word_ru" type="text"
                                    placeholder=" " />
                                <label :class="{ 'label-error': errors.word_ru }">
                                    {{ errors.word_ru ? errors.word_ru[0] : $t("pages.dictionary.translate.ru") }}
                                </label>
                            </div>
                        </div>
                        ...
                        <div class="col-span-12">
                            <fileUploadButton :id="'add_word_audio_file'" :name="'audio_file'" :accept="'audio/*'"
        ...
        <template v-if="word" v-slot:body_content>
            <div class="custom-grid">
                <div v-if="word.image_file" class="col-span-3 lg:col-span-4">
                    <img class="w-full h-auto rounded-xl" :src="config.public.apiBase + '/media/get/' + word.image_file" />
                </div>
                <div :class="word.image_file ? 'col-span-9 lg:col-span-8' : 'col-span-12'">
                    <div class="flex flex-col gap-y-3">
                        <audioPlayerWithWave :src="config.public.apiBase + '/media/get/' + word.audio_file" />
                        <p class="mb-0"><span class="text-inactive">{{
                            $t("pages.dictionary.transcription") }}:</span> <b>[{{ word.transcription }}]</b></p>
                        <p class="mb-0"><span class="text-inactive">{{
                    ...
                    <div class="custom-grid">
                        ...
                        <div class="col-span-12">
                            <previewFileInput v-if="current_word_image" :fileType="'image'"
                                :previewUrl="config.public.apiBase + '/media/get/' + word.image_file" :onChange="() => current_word_image = false" />
                        ...
                        <div class="col-span-12">
                            ...
                            :previewUrl="config.public.apiBase + '/media/get/' + word.audio_file" :onChange="() => current_word_audio = false" />
...
const addWordSubmit = async () => {
    ...
    await $axiosPlugin.post('dictionary/add', formData)
        .then(response => {
            getWords();
            closeAddModal();
        }).catch(err => {
