<template>
  <div class="custom-grid">
    <div class="col-span-12">
      <button
        type="button"
        @click="showHideSentenceSearchFilter"
        class="btn btn-light"
      >
    ...
    <div class="col-span-12">
      <p
        :class="{
          'text-danger':
            errors.sentences_count &&
            selectedSentences.length < props.minimumSentencesCount,
        }"
      >
        <span
          v-if="
      ...
      <div v-if="selectedSentences.length > 0" class="btn-wrap">
        <tag
          ...
          :key="index"
          :itemId="sentence.sentence_id"
          :itemLabel="sentence.sentence"
          :onDelete="(sentence_id) => deleteFromGroup(sentence_id)"
          :closable="true"
          v-motion="{
            initial: {
              y: -100,
