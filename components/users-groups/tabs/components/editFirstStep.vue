    ...
    <div v-if="currentGroup" class="custom-grid">
        <div class="col-span-12">
            <div class="form-group-border active">
                ...
                <input autoComplete="new-group-name" v-model="currentGroup.group_name" name="group_name" type="text"
                    placeholder=" " />
        ...
        <div class="col-span-12">
            <div class="form-group-border active">
                <i class="pi pi-users"></i>
                <textarea autoComplete="new-group-description-name" v-model="currentGroup.group_description"
                    name="group_description" placeholder=" "></textarea>
            ...
            <div class="form-group-border select active label-active">
                ...
                <select name="level_id">
                    ...
                    <option v-for="(level, levelIndex) in selectedCourse?.levels" :key="levelIndex"
                        :selected="currentGroup?.level_id === level.level_id" :value="level.level_id">
        ...
        <div class="col-span-12">
            <div class="form-group-border select active">
                ...
                <select name="mentor_id">
                    ...
                    <option v-for="mentor in attributes.all_mentors" :key="mentor.user_id"
                        :selected="currentGroup?.mentor_id === mentor.user_id" :value="mentor.user_id">{{
